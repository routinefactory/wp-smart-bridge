...
class SB_Admin
{
    ...
    public function enqueue_assets($hook)
    {
        ...
        wp_localize_script('sb-admin', 'sb_i18n', [
            ...
            'click_unit' => __('클릭', 'sb'),
            // v4.0.0: 파라미터 방식으로 퍼마링크 관련 문자열 deprecated
            // 'auto_fixing_permalinks' => deprecated
            // 'auto_fix_failed' => deprecated
            // 'permalink_error_title' => deprecated
            // 'go_to_permalinks' => deprecated
            'please_wait' => __('잠시만 기다려주세요...', 'sb'),
            'health_warning_title' => __('서버에서 링크에 접근할 수 없습니다', 'sb'),
            'health_warning_message' => __('단축 링크가 정상적으로 작동하지 않을 수 있습니다. 서버 상태를 확인해주세요.', 'sb'),
